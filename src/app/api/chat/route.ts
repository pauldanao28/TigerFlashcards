...
2. 難しいと思われる漢字語（N3以上、または文脈上ユーザーが知らない可能性がある語）にのみ、括弧でふりがなを付けてください。形式：漢字（ふりがな）。例：彼女（かのじょ）、勉強（べんきょう）。日・本・人・大・小・山・川・上・下・中・食べる・行く・来る・見る・聞く など基本的な語には不要です。付けすぎないこと。
