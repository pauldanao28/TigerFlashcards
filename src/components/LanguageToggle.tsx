    ...
    <div className="flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="relative z-10 flex w-full text-sm font-bold uppercase">
          <div
            className={`flex-1 flex items-center justify-center transition-colors ${language === "en" ? "text-orange-600" : "text-gray-500"}`}
          >
            English
          </div>
          <div
            className={`flex-1 flex items-center justify-center transition-colors ${language === "jp" ? "text-orange-600" : "text-gray-500"}`}
          >
            日本語
          </div>
        </div>
