...
import { getLevel, bootstrapVocabScore, bootstrapReadingScore } from "@/lib/scoring";
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    const load = async () => {
      ...
      // Bootstrap from existing card data on first load
  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-28">
      ...
      <div className="px-4 grid grid-cols-2 gap-3">
        ...
        <ScoreTile href="/sensei"   emoji="📝" label="Grammar"    score={data.grammar_score}   sub="Chat with Sensei" />
