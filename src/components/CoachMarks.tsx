...
export default function CoachMarks({ onDismiss }: { onDismiss: () => void }) {
  ...
  return (
    <div
      /* 1. pointer-events-none: This is the magic. Swipes will now 
            "pass through" this div and hit the Flashcard underneath.
      */
    ...
    >
      {/* 2. BACKWRAPPING CLICK: 
         We put an invisible div behind the content that is 'pointer-events-auto' 
         so you can still tap anywhere to dismiss the hints.
      */}
      <div
        onClick={onDismiss}
        className="absolute inset-0 bg-slate-900/20 pointer-events-auto rounded-[2.5rem]"
      />
