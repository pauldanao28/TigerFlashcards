    ...
    >
      ...
      <div className="flex justify-between items-center w-full">
        <div className="flex flex-col items-center gap-2 animate-pulse">
          ...
          <span className="text-[10px] font-black text-rose-600 bg-white/80 px-2 py-1 rounded uppercase">Forgot</span>
        </div>
        
        <div className="flex flex-col items-center gap-2 animate-pulse">
          <span className="text-4xl text-emerald-500">→</span>
          <span className="text-[10px] font-black text-emerald-600 bg-white/80 px-2 py-1 rounded uppercase">Know it!</span>
        </div>
      </div>
